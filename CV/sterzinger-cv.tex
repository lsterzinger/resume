...
% Center the name over the entire width of resume:
 \moveleft.5\hoffset\centerline{\large\bf Lucas Sterzinger, PhD}
...
\section{WORK EXPERIENCE} 
    {\sl \textbf{Mission Support/Scientific Software Developer}} \hfill 2023 - Present \\
    NASA Goddard Earth Sciences Data and Information Services Center (GES DISC) \\
    ADNET Systems, Inc \\
    \begin{itemize}
        \item Manage on-prem SIPS data production for AIRS (Aqua) and CrIS/ATMS (SNPP, JPSS-1, and JPSS-2) instruments
        \item Manage end-to-end production, ingest, and archive workflows for Earth science data
...
\section{TECHNICAL} 
    {\sl Languages \& Software:} Python, Perl, Julia, Fortran \\
...
\section{EDUCATION} 
    ...
    Dissertation: \textit{\href{https://escholarship.org/uc/item/1v54c9tv}{Ice, Liquid, and Aerosol: Mixed-Phase Cloud Properties\\and Processes in Regional and Large Eddy Simulations}}
...
\section{PUBLICATIONS}
    {\sl \textbf{Producing Earth science data for impact: Improved commercial cloud usability of \\ archive model data}}
    \hfill 2026 \\ McNally, A., \textbf{Sterzinger, L. J.}, \& Carrol, I. \\ \textit{Environmental Modelling \& Software} \\ \href{https://doi.org/10.1016/j.envsoft.2025.106846}{https://doi.org/10.1016/j.envsoft.2025.106846}

    {\sl \textbf{Above-cloud concentrations of cloud condensation nuclei help to sustain some \\ Arctic low-level clouds}}
    \hfill 2024 \\ \textbf{Sterzinger, L. J.} \& Igel, A. L. \\ \textit{Atmospheric Chemistry and Physics} \\ \href{https://doi.org/10.5194/acp-24-3529-2024}{https://doi.org/10.5194/acp-24-3529-2024}
